...
Full baby name data (1964–2020) for the Republic of Ireland, gathered from the [Central Statistics Office](https://www.cso.ie/en/interactivezone/visualisationtools/babynamesofireland/).
...
Stefan Müller (2021). _iebabynames: Full baby name data for the Republic of Ireland_. R package version 0.2.1. URL: http://github.com/stefan-mueller/iebabynames.
