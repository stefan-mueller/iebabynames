...
The package contains the dataset `iebabynames` with `r nrow(iebabynames)` observations on six variables: `year`, `sex`, `name`, `n`, `rank`, and `prop`. Due to confidentiality reasons, only names with 3 or more instances in the relevant year are included.
