...
Full baby name data (1964–2022) for Ireland, gathered from the [Central Statistics Office](https://www.cso.ie/en/interactivezone/visualisationtools/babynamesofireland/).

The package contains the dataset `iebabynames` with `r nrow(iebabynames)` observations on six variables: `year`, `sex`, `name`, `n`, `rank`, and `prop`, and `prop_sex`. Due to confidentiality reasons, only names with 3 or more instances in the relevant year are included.
...
Stefan Müller (2023). _iebabynames: Ireland Baby Names, 1964-2023_. R package version 0.2.3. URL: http://github.com/stefan-mueller/iebabynames.
